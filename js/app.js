...
// saveBtn.addEventListener('click', saveResult); // 제거됨
...
function getResultInterpretation(resultMapping) {
    const interpretations = {
        ...
        'spring-bright': { // 0: 봄의 밝은 자연
            title: '내면의 고요한 안정감',
            description: '이 그림을 그려낸 당신은 \n마음 깊은 곳에 누구도 흔들 수 없는 고요하고 단단한 뿌리를 내린 사람입니다. \n당신의 안정감은 외부의 화려함이나 시끄러운 것들에서 오는 것이 아니라, \n자신의 내면에서 우러나오는 진정한 평온함입니다.\n\n당신은 급작스러운 변화보다는 천천히, \n하지만 꾸준히 성장해나가는 것을 선호합니다. \n마치 깊은 숲 속의 나무들처럼 시간이 지날수록 더욱 단단해지고 깊어지는 존재입니다. \n다른 사람들이 조급해할 때도 당신은 자신만의 속도를 유지하며 묵묵히 나아갑니다.\n\n당신에게 가장 소중한 것은 마음의 평화와 내적 조화입니다. \n혼자만의 시간을 통해 자신을 돌아보고, \n진정으로 의미 있는 것들에 집중하는 능력이 뛰어납니다. \n때로는 세상이 너무 빠르게 돌아간다고 느낄 수도 있지만, \n당신의 이런 차분함과 깊이가 주변 사람들에게는 큰 위로가 될 것입니다.'
        },
        'spring-soft': { // 1: 봄의 부드러운 실내
            title: '지혜로운 안정감의 균형',
            description: '이 그림을 그려낸 당신은 \n변화와 안정, 새로움과 전통, 개인과 공동체 사이에서 아름다운 균형을 찾은 지혜로운 사람입니다. \n당신은 안정을 추구하지만 고여있지 않으며, \n변화를 받아들이지만 뿌리를 잃지 않습니다.\n\n당신의 안정감은 경직된 것이 아니라 유연하고 적응력이 뛰어납니다. \n마치 바람에 흔들리는 나무가 부러지지 않고 오히려 더 강해지듯이, \n당신도 어려움을 만나면 그것을 성장의 기회로 만들어냅니다.\n\n주변 사람들은 당신과 함께 있으면 안정감을 느끼면서도 답답하지 않다고 말할 것입니다. \n당신은 전통과 새로움을 조화롭게 받아들이며, \n다양한 가치관을 가진 사람들 사이에서 중재자 역할을 자연스럽게 해냅니다. \n이런 당신의 모습은 많은 사람들에게 신뢰감을 주고, \n함께 일하고 싶은 동반자로 여겨질 것입니다.'
        },
        'spring-vivid': { // 2: 봄의 생생한 도시
            title: '역동적인 안정감의 추진력',
            description: '이 그림을 그려낸 당신은 \n안정감을 바탕으로 끊임없이 성장하고 발전해나가는 에너지 넘치는 사람입니다. \n당신의 안정은 정체된 것이 아니라, \n마치 봄날 새싹이 돋아나듯 생명력 넘치는 역동적인 안정입니다.\n\n당신은 변화를 두려워하지 않으면서도, \n그 변화가 건설적이고 의미 있는 방향으로 나아가도록 이끄는 능력이 뛰어납니다. \n새로운 도전을 받아들이되, \n기존의 좋은 것들은 지켜내려고 노력합니다. \n이런 당신의 모습은 주변 사람들에게 용기와 희망을 줍니다.\n\n당신은 개인의 성장뿐만 아니라 공동체의 발전에도 관심이 많습니다. \n사람들을 하나로 모으고, \n함께 성장할 수 있는 환경을 만드는 것에 특별한 재능을 가지고 있습니다. \n당신의 이런 리더십은 강압적이지 않으면서도 \n자연스럽게 사람들이 따르고 싶어하는 매력적인 힘을 발휘할 것입니다.'
        },
        'spring-dark': { // 3: 봄의 신비로운 밤
            title: '무한한 안정감의 수호자',
            description: '이 그림을 그려낸 당신은 \n마치 수백 년을 견뎌온 거대한 나무처럼, \n주변의 모든 것들을 품어주는 따뜻하고 깊은 안정감을 가진 사람입니다. \n당신에게 안정이란 단순히 개인적인 평안함을 넘어서, \n다른 사람들에게도 안식처가 되어주는 소중한 선물입니다.\n\n당신은 어떤 어려움이 와도 흔들리지 않는 강인함을 가지고 있으며, \n동시에 상처받은 사람들을 치유해주는 따뜻함도 함께 가지고 있습니다. \n사람들은 당신과 함께 있으면 마치 깊은 숲 속에서 쉬는 것 같은 평온함을 느낍니다.\n\n당신은 급진적인 변화보다는 점진적이고 지속가능한 발전을 추구하며, \n모든 사람이 조화롭게 공존할 수 있는 환경을 만들기 위해 노력합니다. \n때로는 당신의 이런 신중함을 답답해하는 사람들도 있을 수 있지만, \n시간이 지나면 당신의 선택이 얼마나 지혜로웠는지 깨닫게 될 것입니다.\n\n당신은 이 세상에 진정한 안정과 평화를 가져다주는 귀한 존재입니다. \n당신의 존재 자체가 많은 사람들에게 희망이 되고 있다는 것을 기억해주세요.'
        },
        
        // ☀️ 여름의 그림들
        'summer-bright': { // 4: 여름의 밝은 자연
            title: '내면의 섬세한 창조력',
            description: '이 그림을 그려낸 당신은 \n조용한 작업실에서 혼자만의 시간을 통해 \n깊이 있는 창작의 세계를 만들어가는 섬세한 예술가입니다. \n당신의 창의성은 화려하게 드러나지 않지만, \n마치 장인이 하나의 작품을 완성해가듯 꼼꼼하고 정성스럽습니다.\n\n당신은 남들에게 보여주기 위해서가 아니라, \n자신만의 완벽함을 추구하며 작업에 몰입합니다. \n세상의 시끄러운 소리들은 잠시 잊고, \n오직 자신의 내면에서 우러나오는 영감에만 집중하는 시간들이 당신을 가장 행복하게 만듭니다.\n\n당신의 작품들은 겉으로는 단순해 보일 수 있지만, \n그 안에는 깊은 사색과 진심이 담겨 있습니다. \n완성도를 중시하고, 디테일에 신경쓰며, 시간이 오래 걸리더라도 \n자신이 만족할 수 있는 결과물을 만들어내려고 노력합니다. \n당신의 이런 진정성 있는 창작 태도는 시간이 지날수록 더욱 빛을 발할 것입니다.'
        },
        'summer-soft': { // 5: 여름의 부드러운 실내
            title: '체계적인 창의력의 발휘',
            description: '이 그림을 그려낸 당신은 \n창의성과 현실감각 사이에서 완벽한 균형을 찾은 지혜로운 창작자입니다. \n당신은 상상력을 발휘하면서도 실용성을 놓치지 않으며, \n혁신을 추구하면서도 기본기를 소홀히 하지 않습니다.\n\n당신의 공방은 정돈되어 있으면서도 창의적인 아이디어들로 가득합니다. \n계획을 세우고 단계별로 진행하면서도, \n그 과정에서 새로운 영감이 떠오르면 유연하게 받아들일 줄 아는 사람입니다.\n\n당신은 혼자만의 창작 시간도 소중히 여기지만, \n다른 사람들과의 협업이나 피드백도 적극적으로 받아들입니다. \n자신의 아이디어를 다른 사람들과 나누며 \n함께 발전시켜나가는 과정에서 더 큰 창의력을 발휘합니다. \n이런 당신의 열린 마음과 균형감각은 주변 사람들에게도 좋은 영향을 주며, \n함께 작업하고 싶은 동반자로 인정받을 것입니다.'
        },
        'summer-vivid': { // 6: 여름의 생생한 도시
            title: '열정적인 창조력의 폭발',
            description: '이 그림을 그려낸 당신은 \n머릿속에 떠오르는 아이디어들을 즉시 현실로 만들어내는 역동적인 창작자입니다. \n당신의 공방은 항상 무언가 새로운 것이 만들어지고 있는 활기찬 에너지로 가득합니다.\n\n당신은 완벽함보다는 속도감을 중시하며, \n일단 시작하고 나서 수정해나가는 방식을 선호합니다. \n실패를 두려워하지 않고, 오히려 실패에서 새로운 아이디어를 얻는 능력이 뛰어납니다. \n다양한 분야에 관심이 많고, 여러 프로젝트를 동시에 진행하면서도 \n각각에 열정을 쏟아부을 수 있는 에너지를 가지고 있습니다.\n\n당신의 창작물들은 독창적이고 실험적인 성격이 강하며, \n기존의 틀을 깨고 새로운 방식을 시도하는 것을 즐깁니다. \n때로는 주변 사람들이 당신의 아이디어를 이해하지 못할 수도 있지만, \n당신의 열정과 추진력은 결국 사람들을 놀라게 하는 결과물을 만들어낼 것입니다.'
        },
        'summer-dark': { // 7: 여름의 신비로운 밤
            title: '무한한 열정의 창조자',
            description: '이 그림을 그려낸 당신은 \n창작에 대한 열정이 그 누구보다도 뜨거운 진정한 아티스트입니다. \n당신에게 창작이란 단순한 취미나 일이 아니라, \n살아가는 이유이자 삶 그 자체입니다.\n\n당신의 공방은 마치 용광로처럼 끊임없이 새로운 것들이 만들어지고 변화하는 역동적인 공간입니다. \n24시간이 모자랄 정도로 하고 싶은 것들이 많고, \n머릿속에는 항상 새로운 아이디어들이 폭죽처럼 터져나옵니다.\n\n당신은 기존의 방식에 만족하지 않고 항상 혁신적이고 독창적인 것을 추구합니다. \n때로는 이런 강렬한 창작 욕구 때문에 \n주변 사람들과의 관계나 일상생활에 소홀해질 수도 있지만, \n그만큼 당신이 만들어내는 작품들은 세상에 없던 특별한 것들입니다.\n\n당신의 이런 타오르는 창작 정신은 세상을 더 아름답고 흥미롭게 만드는 원동력입니다. \n당신은 예술가로, 창조자로, 혁신가로 태어난 사람입니다. \n때로는 외로울 수도 있지만, 당신의 열정이 만들어내는 작품들은 \n많은 사람들에게 영감과 감동을 줄 것입니다.\n\n당신의 불타는 열정을 믿고, 계속해서 세상에 없던 새로운 것들을 창조해나가세요.'
        },
        
        // 🍂 가을의 그림들
        'autumn-bright': { // 8: 가을의 밝은 자연
            title: '차분하고 내향적인 관계 추구형',
            description: '이 그림을 그려낸 당신은 \n소중한 사람들과의 깊고 진실한 연결을 무엇보다 소중히 여기는 사람입니다. \n당신에게 관계란 시끄럽고 화려한 것이 아니라, \n마치 따뜻한 햇살이 조용히 스며드는 것처럼 은은하면서도 깊은 의미를 갖습니다.\n\n당신은 많은 사람들과 얕은 관계를 맺기보다는, \n진심으로 마음을 나눌 수 있는 몇 명의 사람들과 깊이 있는 관계를 선호합니다. \n때로는 새로운 사람들과의 만남이 부담스럽게 느껴질 수도 있지만, \n한번 마음을 연 상대에게는 변함없는 따뜻함과 신뢰를 보여주는 당신입니다.\n\n조용한 카페에서 나누는 진솔한 대화, 함께하는 고요한 산책, \n말없이도 서로를 이해하는 순간들이 당신에게는 가장 소중한 시간들이겠죠.'
        },
        'autumn-soft': { // 9: 가을의 부드러운 실내
            title: '조화로운 관계 균형형',
            description: '이 그림을 그려낸 당신은 \n혼자만의 시간과 사람들과의 시간 사이에서 \n아름다운 균형감을 찾은 지혜로운 사람입니다. \n당신은 관계의 소중함을 알면서도, \n자신만의 공간과 시간의 필요성 역시 잘 알고 있습니다.\n\n당신에게 인간관계는 마치 적당한 햇살처럼 따뜻하면서도 부담스럽지 않은 것입니다. \n사람들과 함께할 때는 진심으로 그 순간을 즐기지만, \n동시에 혼자만의 시간을 통해 자신을 돌아보고 재충전하는 시간도 소중히 여깁니다.\n\n당신의 주변 사람들은 당신의 이런 균형잡힌 모습에서 안정감을 느끼며, \n당신과 함께 있을 때 편안함과 자연스러움을 경험합니다. \n당신은 관계에서 무리하지 않으면서도 진정성을 잃지 않는, \n성숙한 관계 맺기의 달인이라고 할 수 있어요.'
        },
        'autumn-vivid': { // 10: 가을의 생생한 도시
            title: '적극적인 관계 주도형',
            description: '이 그림을 그려낸 당신은 \n사람들과의 만남에서 에너지를 얻고, \n그 에너지를 다시 주변 사람들에게 나누어주는 따뜻한 태양 같은 존재입니다. \n당신은 관계에서 수동적으로 기다리기보다는 \n먼저 다가가고, 먼저 관심을 표현하며, 먼저 손을 내미는 사람입니다.\n\n당신의 밝고 긍정적인 에너지는 주변 사람들에게 활력을 주고, \n때로는 소극적이던 사람들도 당신 덕분에 마음을 열게 됩니다. \n새로운 만남을 두려워하지 않고, 오히려 설렘으로 받아들이는 당신의 모습은 \n많은 사람들에게 영감을 줍니다.\n\n당신은 그룹에서 자연스럽게 분위기 메이커 역할을 하며, \n사람들 사이의 관계를 연결해주는 다리 같은 존재입니다. \n때로는 너무 많은 관계에 에너지를 쏟아 지칠 수도 있지만, \n사람들과의 소중한 추억들이 당신에게는 가장 큰 보물이 될 것입니다.'
        },
        'autumn-dark': { // 11: 가을의 신비로운 밤
            title: '열정적인 관계 몰입형',
            description: '이 그림을 그려낸 당신은 \n사랑하는 사람들을 위해서라면 무엇이든 할 수 있는, \n뜨거운 마음을 가진 사람입니다. \n당신에게 관계란 단순한 인연이 아니라 \n삶의 가장 중요한 의미이자 원동력입니다.\n\n당신은 사람을 사랑할 때 전심전력으로 사랑하고, \n친구를 대할 때도 온 마음을 다해 대합니다. \n당신의 이런 진심어린 마음은 상대방에게 깊은 감동을 주며, \n당신 주변에는 항상 당신의 따뜻함에 감화된 사람들이 모여들게 됩니다.\n\n때로는 당신의 이런 열정이 상대방에게 부담이 될까 걱정하기도 하고, \n때로는 사람들이 당신만큼 진심으로 대하지 않는 것 같아 상처받기도 할 것입니다. \n하지만 당신의 이런 따뜻하고 진실한 마음이야말로 \n이 세상을 더 아름답게 만드는 귀한 선물이라는 것을 기억해주세요.\n\n당신은 사랑받기 위해 태어난 사람이고, \n동시에 사랑을 나누어주기 위해 태어난 사람입니다.'
        },
        
        // ❄️ 겨울의 그림들
        'winter-bright': { // 12: 겨울의 밝은 자연
            title: '내면의 평온한 독립성',
            description: '이 그림을 그려낸 당신은 \n겉으로는 조용해 보이지만, 마음 깊은 곳에는 누구도 건드릴 수 없는 \n자신만의 바다를 품고 있는 사람입니다. \n당신의 자유는 시끄럽거나 화려하지 않습니다. \n마치 고요한 바다 깊은 곳처럼 조용하지만 무한히 넓고 깊은 자유입니다.\n\n당신은 다른 사람들의 기대나 시선에 휘둘리지 않고, \n자신만의 속도와 방향으로 살아가는 법을 알고 있습니다. \n때로는 주변 사람들이 당신을 이해하지 못할 수도 있지만, \n당신은 그런 것들에 크게 흔들리지 않습니다.\n\n당신에게 가장 소중한 것은 마음의 평화와 내면의 자유입니다. \n혼자만의 시간을 통해 자신과 마주하고, \n진정으로 원하는 것이 무엇인지 깊이 사색하는 시간들이 당신을 가장 행복하게 만들 것입니다. \n당신의 이런 고요한 깊이는 시간이 지날수록 더욱 큰 힘이 될 거예요.'
        },
        'winter-soft': { // 13: 겨울의 부드러운 실내
            title: '적응력 있는 독립성',
            description: '이 그림을 그려낸 당신은 \n자유로움과 책임감 사이에서 아름다운 균형을 찾은 현명한 사람입니다. \n당신은 자유를 추구하지만 \n동시에 주변 상황과 사람들을 배려할 줄도 아는, \n성숙한 자유인입니다.\n\n당신의 자유는 마치 잔잔한 파도처럼 유연하고 적응력이 뛰어납니다. \n때로는 규칙과 틀 안에서도 자신만의 방식을 찾아내고, \n때로는 과감하게 새로운 길을 개척하기도 합니다. \n중요한 것은 어떤 상황에서든 \n자신다움을 잃지 않으면서도 조화를 이룰 줄 안다는 점입니다.\n\n당신은 계획을 세우는 것도 좋아하지만, 그 계획에 너무 얽매이지는 않습니다. \n상황에 따라 유연하게 변화할 수 있는 여유로움이 당신의 큰 매력입니다. \n이런 당신의 모습은 주변 사람들에게도 좋은 영향을 주며, \n함께 있으면 편안함을 느끼게 해줍니다.'
        },
        'winter-vivid': { // 14: 겨울의 생생한 도시
            title: '모험적인 도전 정신',
            description: '이 그림을 그려낸 당신은 \n새로운 경험과 모험을 두려워하지 않는 용감한 개척자입니다. \n당신의 자유는 정적이지 않습니다. \n마치 파도를 타는 서퍼처럼 역동적이고 에너지 넘치는 자유를 추구합니다.\n\n당신은 반복되는 일상보다는 예측할 수 없는 새로운 경험들을 선호합니다. \n여행을 좋아하고, 새로운 사람들을 만나는 것을 즐기며, \n도전적인 일들에 흥미를 느낍니다. \n때로는 주변 사람들이 당신의 선택을 무모하다고 생각할 수도 있지만, \n당신은 안전한 길보다는 의미 있는 길을 선택하는 사람입니다.\n\n실패를 두려워하지 않고, 실패마저도 값진 경험으로 받아들이는 당신의 태도는 정말 멋집니다. \n당신의 이런 도전 정신과 자유로운 영혼은 많은 사람들에게 영감을 주고, \n세상을 더 넓게 보는 시야를 선물해줄 것입니다.'
        },
        'winter-dark': { // 15: 겨울의 신비로운 밤
            title: '무한한 가능성을 향한 질주',
            description: '이 그림을 그려낸 당신은 \n자유에 대한 갈망이 그 누구보다도 강렬한 사람입니다. \n당신에게 자유란 선택사항이 아니라 삶의 필수 요소이며, \n숨쉬는 것만큼이나 자연스럽고 중요한 것입니다.\n\n당신은 어떤 제약이나 한계도 받아들이기 어려워하며, \n항상 더 넓은 세상, 더 큰 가능성을 꿈꿉니다. \n때로는 이런 강렬한 자유 의지 때문에 주변 사람들과 갈등을 겪기도 하고, \n안정을 추구하는 사람들로부터 이해받지 못할 때도 있을 것입니다.\n\n하지만 당신의 이런 타오르는 자유 정신이야말로 세상을 변화시키는 원동력입니다. \n당신은 기존의 틀을 깨고 새로운 길을 만들어가는 선구자적 역할을 하며, \n다른 사람들이 꿈꾸지도 못했던 가능성들을 현실로 만들어낼 수 있는 사람입니다.\n\n때로는 무모해 보일 수도 있지만, 당신의 이런 거침없는 자유로움이 \n세상에 새로운 바람을 불러일으킬 것입니다. \n당신은 진정한 자유인으로 태어난 사람이에요.'
        }
    };
